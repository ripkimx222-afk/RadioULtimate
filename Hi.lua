...
local CFG = {
  ...
  font = 1, textScale = 2, lang2 = "ru", menuOpacity = 1,
}
...
buildUI = function()
  ...
  local SCALE = SCALE_OPTIONS[CFG.textScale] or 1.0
  local function SZ(n) return math.floor(n*SCALE + 0.5) end
  local MENU_TRANS = 1 - (CFG.menuOpacity or 1)
  ...
  main.BackgroundColor3 = BG; main.BackgroundTransparency = MENU_TRANS; main.BorderSizePixel = 0
  ...
  renderSettings = function()
    ...
    opLbl.Size = UDim2.new(1,0,0,16); opLbl.BackgroundTransparency = 1
    opLbl.TextColor3 = TXM; opLbl.Font = FONT_BOLD; opLbl.TextSize = SZ(9)
    opLbl.TextXAlignment = Enum.TextXAlignment.Left; opLbl.ZIndex = 53; opLbl.Parent = scroll

    local opSlider = Instance.new("Frame"); opSlider.Size = UDim2.new(1,0,0,28)
    opSlider.BackgroundTransparency = 1; opSlider.ZIndex = 53; opSlider.Parent = scroll
    local opTrack = Instance.new("Frame"); opTrack.Size = UDim2.new(1,0,0,8)
    opTrack.Position = UDim2.new(0,0,0.5,-4)
    opTrack.BackgroundColor3 = PANA; opTrack.BorderSizePixel = 0; opTrack.ZIndex = 54; opTrack.Parent = opSlider
    ...
    local opKnob = Instance.new("Frame"); opKnob.Size = UDim2.new(0,20,0,20)
    ...
    Instance.new("UICorner", opKnob).CornerRadius = UDim.new(1,0)
    ...
    UIS.InputEnded:Connect(function(i)
      if opDragging and (i.UserInputType == Enum.UserInputType.MouseButton1 or i.UserInputType == Enum.UserInputType.Touch) then
        opDragging = false
        saveConfig()
        main.BackgroundTransparency = 1 - CFG.menuOpacity
      end
    end)
  ...
  if not _G.__RiseUltimateFirstShow then
    ...
    main.Visible = true
    main.Position = UDim2.new(0.07,0,0.04,0)
  end
